...
test_df = pd.read_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\TestingDataBinary.csv",header=None)
...
def logistic_regression(X_train_scaled, y_train, X_val_scaled, y_val,test_features_scaled,test_df):
    ...
    test_results_df.to_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\LogisticTestingDataBinary.csv", index=False)
...
def knn(X_train_scaled, y_train, X_val_scaled, y_val,test_features_scaled,test_df):
    ...
    test_results_df = pd.DataFrame(test_df)
    test_results_df['Label'] = test_predictions
    test_results_df.to_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\KnnTestingDataBinary.csv", index=False)
...
def random_forest(X_train_scaled, y_train, X_val_scaled, y_val, test_features_scaled, test_df):
    ...
    test_results_df = pd.DataFrame(test_df)
    test_results_df['Label'] = test_predictions
    test_results_df.to_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\RandomForestTestingDataBinary.csv", index=False)

    # Step 6: Report and analysis Random Forest was chosen to be the final model.
    print("Testing Results:")
    #print(test_results_df['Label'])
...
def svm(X_train_scaled, y_train, X_val_scaled, y_val,test_features_scaled,test_df):
    ...
    test_results_df = pd.DataFrame(test_df)
    test_results_df['Label'] = test_predictions
    test_results_df.to_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\SVMTestingDataBinary.csv", index=False)
...
def decision_tree(X_train_scaled, y_train, X_val_scaled, y_val,test_features_scaled,test_df):
    ...
    test_results_df = pd.DataFrame(test_df)
    test_results_df['Label'] = test_predictions
    test_results_df.to_csv("C:\\Users\\93241\\OneDrive - University of Southampton\\COMP3217\\ml\\DecisionTestingDataBinary.csv", index=False)
